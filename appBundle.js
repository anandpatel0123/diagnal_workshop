 ...
 * CLI version: 2.11.0
 * 
 * Generated: Sat, 06 May 2023 13:01:33 GMT
 */
...
var APP_com_domain_app_diagnalworkshop = (function () {
  ...
  class Clock extends Lightning$1.Component {
    static _template() {
      return {
        Clock: {
          x: 1150,
    ...
    _init() {
      ...
      Registry.setInterval(() => {
        const d = new Date();
        this.time = "".concat(d.getHours(), ":").concat(String(d.getMinutes()).padStart(2, '0'));
      }, 1000);
    }
  }

  class Background extends Lightning$1.Component {
    static _template() {
      return {
        w: w => w,
        h: h => h,
  ...
  class PortraitTray extends Lightning$1.Component {
    static _template() {
      return {
        Container: {
          transitions: {
  ...
  class App extends Lightning$1.Component {
    ...
    async onRequestItems(data) {
      ...
      return (items === null || items === void 0 ? void 0 : items.length) > 0 ? true : false;
    }
    _init() {
    ...
    trayRendring() {
      if (this.totalItemsRendered < this.totalItems && this.pageId <= this.pages.length) {
        ...
        if ((content === null || content === void 0 ? void 0 : (_content$page$content = content.page["content-items"]) === null || _content$page$content === void 0 ? void 0 : (_content$page$content2 = _content$page$content.content) === null || _content$page$content2 === void 0 ? void 0 : _content$page$content2.length) > 0) {
          ...
          let trayItems = [];
          content === null || content === void 0 ? void 0 : (_content$page$content3 = content.page["content-items"]) === null || _content$page$content3 === void 0 ? void 0 : (_content$page$content4 = _content$page$content3.content) === null || _content$page$content4 === void 0 ? void 0 : _content$page$content4.forEach(item => {
            trayItems.push({
              w: 160,
              h: 240,
              type: PortraitTray,
